...
export const QUESTIONS: Question[] = [
  ...
  { id: 'lbsRatedVoltage', group: 'receiving', label: 'LBSの定格電圧', type: 'text', unit: 'V', defaultValue: '7200', showIf: { key: 'mainBreakerForm', eq: 'pfs' }, ask: 'always' },
  ...
  { id: 'ctRatio', group: 'receiving', label: 'CTの変流比', type: 'text', placeholder: '300A/5A', ask: 'always' },
  { id: 'vtRatio', group: 'receiving', label: 'VTの変圧比', type: 'text', defaultValue: '6600/110V', ask: 'always' },
  {
    id: 'hasZpd',
    group: 'receiving',
